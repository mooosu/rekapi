rekapiModules.push(function (context) {
  ...
  /**
   * You can use Rekapi to render to an HTML5 `<canvas>`.  To do so, just
   * provide a `CanvasRenderingContext2D` instance to the
   * [`Rekapi`](../../src/rekapi.core.js.html#Rekapi) constructor to
   ...
   * with [`Rekapi#on`](../../src/rekapi.core.js.html#on) (and unbind from with
   * [`Rekapi#off`](../../src/rekapi.core.js.html#off)):
   *
   ...
   *
   * __Note__: `Rekapi.CanvasRenderer` is instantiated for you automatically as
   ...
   * provide a `CanvasRenderingContext2D` to the
   * [`Rekapi`](../../src/rekapi.core.js.html#Rekapi) constructor, you must
   * instead initialize the renderer yourself.  The `CanvasRenderingContext2D`
   * that would have been provided to the
   * [`Rekapi`](../../src/rekapi.core.js.html#Rekapi) constructor instead is
   * provided as the second parameter to `Rekapi.CanvasRenderer`:
   *
   *
   ...
   * later an actor is added to an animation (with
   * [`Rekapi.addActor`](../../src/rekapi.core.js.html#addActor)), the higher
   * its layer.  Lower layers (starting with 0) are rendered earlier.
   *
   * `layer` should be within `0` and the total number of actors in the
   * animation.  The total number of layers in the animation can be found with
   * [`Rekapi.getActorCount`](../../src/rekapi.core.js.html#getActorCount).
   *
   * This method has no effect if an order function is set with
   * [`setOrderFunction`](#setOrderFunction).
   *
   ...
   * `radius`
   * [`Rekapi.KeyframeProperty`](../../src/rekapi.keyframe-property.js.html).
   * The circles will be rendered in order of the value of their `radius`, from
   ...
   *
   * If a render order function is specified, layer changes made
   * [`moveActorToLayer`](#moveActorToLayer) will be ignored.
   *
  ...
  /**
   * Remove the order function set by [`setOrderFunction`](#setOrderFunction).
   * The render order defaults back to the order in which the actors were
   * added.
   *
